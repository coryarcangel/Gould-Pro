...
9. To generate the audio file final.aif from video-score.txt and save audio file as final.aif: perl gould-makeaudio.pl video-score.txt final.aif
10. To generate a Jpeg sequence in folder MovieSeq from score.txt: perl gould-makevideo.pl video-score.txt
11. At the point you can glue the final.aif and Jpeg sequence together. I use Quicktime player, open sequence, and then open aif and "add to movie". 
